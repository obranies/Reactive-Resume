	...
	"properties": {
		...
		"summary": {
			...
			"properties": {
				...
				"showHeading": {
					"default": true,
					"description": "Whether to show the summary heading, icon, and decoration while retaining summary content.",
					"type": "boolean"
				},
				"keepTogether": {
					"default": false,
			...
			"properties": {
				"profiles": {
					...
					"properties": {
						...
						"showHeading": {
							"default": true,
							"description": "Whether to show the section heading, icon, and decoration while retaining section content.",
							"type": "boolean"
						},
						"keepTogether": {
							"default": false,
						...
						"items": {
							...
							"items": {
								...
								"properties": {
									...
									"keepTogether": {
										"default": false,
										"description": "If true, this item is kept together on a single page instead of splitting across a page break.",
										"type": "boolean"
									},
									"icon": {
										"type": "string",
									...
									"roles": {
										...
										"items": {
											...
											"properties": {
												...
												"keepTogether": {
													"default": false,
													"description": "If true, this role is kept together on a single page instead of splitting across a page break.",
													"type": "boolean"
												}
											},
											"required": [
